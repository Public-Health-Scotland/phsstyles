...
phs_palettes <- list(
  "main" = phs_colours(
    c("phs-purple", "phs-magenta", "phs-blue", "phs-green"),
    keep_names = TRUE
  ),
  "supporting" = phs_colours(
    c("phs-graphite", "phs-teal", "phs-liberty", "phs-rust"),
    keep_names = TRUE
  ),
  "all" = phs_colours(
    c(
  ...
  "main-blues" = phs_colours(
    c("phs-blue", "phs-blue-80", "phs-blue-50", "phs-blue-30", "phs-blue-10"),
    keep_names = TRUE
  ),
  "main-greens" = phs_colours(
    c(
      "phs-green",
      "phs-green-80",
      "phs-green-50",
  ...
  "supporting-teals" = phs_colours(
    c("phs-teal", "phs-teal-80", "phs-teal-50", "phs-teal-30", "phs-teal-10"),
    keep_names = TRUE
  ),
  ...
  "supporting-rusts" = phs_colours(
    c("phs-rust", "phs-rust-80", "phs-rust-50", "phs-rust-30", "phs-rust-10"),
                                              keep_names = TRUE),
