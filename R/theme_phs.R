...
theme_phs <- function() {
  ...
  ggplot2::theme(
    ...
    legend.text = ggplot2::element_text(family = fontStyle, size = fontSize),
    ...
    axis.title = ggplot2::element_text(family = fontStyle, size = fontSize),
    axis.text = ggplot2::element_text(family = fontStyle, size = fontSize),
    axis.text.x = ggplot2::element_text(
      size = fontSize, # X-Axis text
      vjust = 0.5
    ),
