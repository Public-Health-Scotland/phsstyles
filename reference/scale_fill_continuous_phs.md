# Continuous colour filling scales for PHS
...
There are a list of continuous colour filling scales using interpolated
method that can be used for PHS charts, such as interpolating colours
for main-purples which contains phs-purple, phs-purple-80,
